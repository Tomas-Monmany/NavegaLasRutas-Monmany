...
const products = [
  ...
  },
  {
    ...
    description:
      "ACTÚA INCREMENTANDO LOS DEPÓSITOS MUSCULARES DE FOSFOCREATINA, FAVORECIENDO LA PERFORMANCE Y RESISTENCIA MUSCULAR. ",
    stock: 20,
    category: "creatinas",
  },
  {
    ...
    description:
      "Puros aminoácidos micronizados de rápida asimilación, llega más rápido a toda tu fibra muscular. ",
    stock: 5,
